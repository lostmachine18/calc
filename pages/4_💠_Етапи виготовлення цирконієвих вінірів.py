...
from pages.data.table_5 import *
...
if authentication_status:
    st.markdown("# Етапи виготовлення цирконієвих вінірів цифровим та аналоговим методом")
    ...
    quantity = st.number_input("Цирконієвий вінір", min_value=1, placeholder="Введіть кількість", value=1)
    ...
    if st.button('Зберегти інформацію', key=10):
