...
from pages.data.table_8 import *
...
if authentication_status:
    st.markdown("# Етапи виготовлення цирконієвих мостоподібних протезів цифровим та аналоговим методом")
    ...
    quantity = st.number_input("Цирконієвий мостоподібний протез (3 зуба)", min_value=1, placeholder="Введіть кількість", value=1)
    ...
    if st.button('Зберегти інформацію', key=13):
