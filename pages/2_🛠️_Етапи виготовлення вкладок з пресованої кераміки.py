...
from pages.data.table_3 import *
...
if authentication_status:
    st.markdown("# Етапи виготовлення вкладок з пресованої кераміки цифровим та аналоговим методом")
    ...
    quantity = st.number_input("Прес-керамічний вкладка", min_value=1, placeholder="Введіть кількість", value=1)
    ...
    if st.button('Зберегти інформацію', key=8):
